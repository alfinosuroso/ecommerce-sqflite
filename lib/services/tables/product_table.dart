...
class ProductTable {
  ...
  static const String PRODUCTS_SELLER_ID = 'sellerId';
  ...
  static void createTable(Database db, int version) async {
    await db.execute('''
      CREATE TABLE $PRODUCTS_TABLE (
        ...
        $PRODUCTS_SELLER_ID INTEGER NOT NULL,
        FOREIGN KEY ($PRODUCTS_SELLER_ID) REFERENCES ${UserTable.USERS_TABLE} (${UserTable.USERS_ID}).}
      )
    ''');
  }
}
